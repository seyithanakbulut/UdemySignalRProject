...
{
    // dağıtım işlemni burdan yapacaz. Sunucu görevi yapacak
    public class SignalRHub : Hub
    {
		...
		public SignalRHub(ICategoryService categoryService, IProductService productService, IBookingService bookingService, IOrderService orderService, IMoneyCaseService moneyCaseService, IMenuTableService menuTableService, INotificationService notificationService)
		{
        ...
        // static yapınca oldu anlık client sayısı
